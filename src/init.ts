...
// Show Banner
const showBanner = () => {
    const banner = figlet.textSync('coremcp', { font: 'Big' });
    console.log(yellow(banner));
    console.log(yellow('🚀 Welcome to the coremcp Configurator\n'));
};
...
const configureClaude = async (config: object): Promise<boolean> => {
    ...
    console.log(yellow('✅ coremcp configured for Claude Desktop. Please RESTART your Claude to enjoy it 🎉'));
    return true;
};
